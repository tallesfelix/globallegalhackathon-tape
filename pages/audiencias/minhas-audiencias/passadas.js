...
class AudienciasPassadas extends React.Component {
                ...
                <Container style={{paddingTop: '2em', backgroundColor: 'white', paddingBottom: '1.5em', marginBottom:'5em', borderRadius: '5px', transform: 'translateY(-100px)' }}>
                        ...
                        <Card.Group stackable itemsPerRow={3}>
                            ...
                            {this.props.audiencia.audiencias.map(audiencia => (
                                <>
                                {audiencia.entidade === 'Semace' && audiencia.status === 'passada' &&
                                    <Card>
                                        <Card.Content>
                                            <Image
                                                floated='right'
...
export default connect(mapStateToProps,mapDispatchToProps)(AudienciasPassadas)
